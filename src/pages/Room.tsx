...
export function Room() {
  ...
  const roomId = params.id; //referencia ao slug da rota
      ...
      <header>
        <div className="content"> 
          ...
          <div>
            ...
            <Button isOutlined onClick={backToHome}>Voltar</Button>
          </div>
        </div>
      </header>
      <main>
        ...
        <form onSubmit={handleSendQuestion}>
          ...
          <div className="form-footer">
            ...
            <Button type="submit" disabled={!user || (endedAt !== null && endedAt !== undefined)}>Enviar pergunta</Button>
          </div>
        </form>
          ...
          { (questions && questions.length > 0) 
            ? questions.map(question => {
              ...
              <div className="empty-list">
                <img src={emptyQuestionsImg} alt="Não há perguntas na sala!" /> 
